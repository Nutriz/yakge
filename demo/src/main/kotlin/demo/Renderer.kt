...
class Renderer(window: Window) {
    ...
    private val shaderProgram = ShaderProgram(
        Paths.get("shader/vertex.glsl").readText(),
        Paths.get("shader/fragment.glsl").readText()
    )

    private val hudShaderProgram = ShaderProgram(
        Paths.get("shader/hud_vertex.glsl").readText(),
        Paths.get("shader/hud_fragment.glsl").readText()
    )
