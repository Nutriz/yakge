...
public class UiRenderer {
    ...
    public UiRenderer(long win) {
        this.win = win;
        try {
            this.ttf = ioResourceToByteBuffer("font/JetBrainsMono-Regular.ttf", 512 * 1024);
        } catch (IOException e) {
...
//                glClearColor(bg.r(), bg.g(), bg.b(), bg.a());
    ...
    public static ByteBuffer ioResourceToByteBuffer(String resource, int bufferSize) throws IOException {
        ...
        if (Files.isReadable(path)) {
            ...
            try (
                    InputStream source = UiRenderer.class.getClassLoader().getResourceAsStream(resource);
